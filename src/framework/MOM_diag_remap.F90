...
type :: diag_remap_ctrl
  ...
  logical :: remap_umo !< If true, umo should be remapped and stored
  logical :: remap_vmo !< If true, vmo should be remapped and stored
  logical :: remap_wmo !< If true, wmo should be remapped and stored
